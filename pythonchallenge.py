...
scramble = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
print(p.match("TTTeTTT"))
print(p.match("TTTfTTTfdfdfdf"))
print(p.findall(scramble))